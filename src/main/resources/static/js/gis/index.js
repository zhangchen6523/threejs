function init() {
    ...
    var vbox = ht.ui.dsl.vbox
    var hbox = ht.ui.dsl.hbox
    var label = ht.ui.dsl.label
    var displayview = ht.ui.dsl.displayview
    var echartview = ht.ui.dsl.echartview
    var relativelayout = ht.ui.dsl.relativelayout
    var htview = ht.ui.dsl.htview
    ...
    var g3d = new ht.graph3d.GlobalView(dm3d);
    window.g3d = g3d
    ...
    function initBuild() {
        ht.Default.xhrLoad(['/js/build/scenes/HT智能建筑-科技风格.json', '/js/build/displays/智能楼宇-jc.json'], function (res) {
    ...
    function showBuild(data) {
        ...
        dataBuild = dm3d.getDataByTag(tag);
        var floor = 'floor' + index;
        data = dm3d.getDataByTag(floor);
        setNodeVisible(dataBuild, true);
    ...
    function addWindSite(name, lat, lng) {
        ...
        setInterval(function () {
            var rotation = node.a('fanRotation')
