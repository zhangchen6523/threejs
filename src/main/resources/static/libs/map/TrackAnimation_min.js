...
(function () {
    ...
    var i = 2;
    var b = 0;
    var g = BMapGLLib.TrackAnimation = function (l, j, k) {
        this._map = l;
        this._polyline = j;
        this._totalPath = j.getPath();
        this._overallView = l.getViewport(j.getPath());
        this._status = i;
        this._opts = {zoom: this._getZoom(), tilt: e, duration: a, delay: h, overallView: c};
        this._initOpts(k);
    ...
    g.prototype._updateViewAni = function () {
        ...
        var k = {duration: p, delay: 0, interation: 1};
