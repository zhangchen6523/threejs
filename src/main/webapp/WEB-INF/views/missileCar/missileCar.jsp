...
<script>
    ...
    function loadMtl(){
        ...
        var path = 'assets/objs/missileCar/';
        loder.setPath(path);
        loder.load("missileCar.mtl",function (materials) {
            materials.preload();
            var objLoader = new THREE.OBJLoader();
            objLoader.setMaterials(materials);
            objLoader.setPath(path);
            objLoader.load('missileCar.obj', function(object) {
                object.scale.set(100, 100, 100);
                object.translateY(-10);//沿着y轴正方向平移距离
